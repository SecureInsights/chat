...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			'meta.keywords': 'end-to-end encryption, security, chat, WebSocket, Cloudflare Workers, JavaScript, E2EE, anonymous communication, AES-GCM, ECDH, HKDF, PBKDF2, security, open source, NodeCrypt, shuaiplus',
			...
			'help.e2e_encryption_desc': 'Uses ECDH + HKDF + AES-GCM authenticated encryption, messages can only be decrypted by you and the recipient',
	...
	zh: {
		...
		translations: {
			...
			'meta.keywords': '端到端加密, 安全, 聊天, WebSocket, Cloudflare Workers, JavaScript, E2EE, 匿名通信, AES-GCM, ECDH, HKDF, PBKDF2, 安全, 开源, NodeCrypt, shuaiplus',
			...
			'help.e2e_encryption_desc': '使用 ECDH + HKDF + AES-GCM 认证加密，消息仅您和接收者可解密',
